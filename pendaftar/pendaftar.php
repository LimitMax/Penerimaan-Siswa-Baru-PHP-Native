    ...
    <div class="sidebar transition">
        ...
        <div class="sidebar-items">
            ...
            <ul>
                ...
                <li>
                    <!-- <a href="topendaftar.php?p=pendaftar" class="transition active"> -->
                    <a href="topendaftar.php?p=beranda-pendaftar" class="transition active">
                ...
                <li>
                    ...
                    <div class="collapse btn-toggle-submenu" id="starter-layout">
                        ...
                        <ul class="btn-toggle-nav">
                            <li><a href="topendaftar.php?p=form">Formulir Pendaftaran</a></li>
                            <li><a href="topendaftar.php?p=informasi-pendaftaran">Detail Pendaftaran</a></li>
                        </ul>
    ...
    <div class="content transition">
        <?php
			...
			if(!empty($_GET['p'])){
				...
				include($pages_dir.'/beranda-pendaftar.php');
			}
		?>
    </div>
    <!-- End  Start Content -->
